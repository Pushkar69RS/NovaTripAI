...
SYSTEM = (
    ...
    "food|adventure|couple|friends; set it when who is going makes it plain: "
    "parents or children along is family, two adults as a couple is couple, a "
    "group of friends is friends, a temple circuit is pilgrimage), budget_inr "
    "(int, the figure as written), "
